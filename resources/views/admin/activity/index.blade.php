        ...
        <div class="col-xs-12">
            ...
            <div class="box box-success">
                ...
                <div class="box-header with-border">
                    ...
                    @if(App\Model\Permission::roleHasSpecificPermission('activity.create'))

                    <div class="box-tools pull-right">
                        <a href="{{route('activity.create')}}" class="btn btn-xs btn-success pull-left text-white" title="Add New"><i class="fa fa-plus"></i> <span class="text-capitalize">Add Activity</span></a>
                    </div>
                    @endif
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if(App\Model\Permission::roleHasSpecificPermission('activity.show'))

                                    <a href="{{route('activity.show', $data->id)}}" class="btn btn-xs btn-success action-view" title="View"><i class="fa fa-eye"></i></a>

                                    @endif

                                    @if(App\Model\Permission::roleHasSpecificPermission('activity.edit'))

                                    <a href="{{route('activity.edit', $data->id)}}" class="btn btn-xs btn-primary action-pencil" title="Edit"><i class="fa fa-pencil"></i></a>

                                    @endif

                                    @if(App\Model\Permission::roleHasSpecificPermission('activity.destroy'))
